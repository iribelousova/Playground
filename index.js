...
function clearAll() {
  ...
  const image = document.querySelector(".meme-class")
  if (image) {
    image.remove();
  }
  
  const joke = document.querySelector(".joke-class")
  if (joke) {
    joke.remove();
  }
  
  const quote = document.querySelector(".quote-class")
  if (quote) {
    quote.remove();
  }
  
  const riddle = document.querySelector(".riddle-class")
  if (riddle) {
    riddle.remove();
  }
  
  const riddleanswer = document.querySelector(".riddleanswer-class")
  if (riddleanswer) {
    riddleanswer.remove();
  }
...
function showMeme() {
  ...
  clearAll()
  const newSection = document.getElementById("memeSection")
  const newElement = document.createElement('img')
  newElement.className = 'meme-class';
  newElement.src = randomMemeUrl; 
  newElement.alt = 'Random meme image';
  
  newSection.insertAdjacentElement('afterend', newElement);
}
...
function showJoke() {
  ...
  const newSection = document.getElementById("jokeSection")
  const newElement = document.createElement('p')
  newElement.className = 'joke-class';
...
function showQuote() {
  ...
  const newSection = document.getElementById("quoteSection")
  const newElement = document.createElement('p')
  newElement.className = 'quote-class';
...
function showRiddle() {
  ...
  const newSection = document.getElementById("riddleSection")
  const newElement = document.createElement('p')
  newElement.className = 'riddle-class';
...
function revealAnswers() {
  ...
  const isAnswered = document.querySelector(".riddleanswer-class")
  const riddle = document.querySelector(".riddle-class")
    
  if (riddle && !isAnswered) {
    const newElement = document.createElement('p')
    newElement.className = 'riddleanswer-class';
    newElement.textContent = riddleanswer; 

    riddle.insertAdjacentElement('afterend', newElement);
  } else if (riddle && isAnswered) {
    alert('The riddle answer has already been revealed!')
  } else {
    alert('There is no riddle to reveal! Please, click on "Riddle me" first.')
  }
